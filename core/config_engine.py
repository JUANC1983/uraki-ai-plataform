...
class RiskThresholds(BaseModel):
    ...
    medium: RiskThresholdBand = Field(default_factory=lambda: RiskThresholdBand(min=31, max=70))
    high: RiskThresholdBand = Field(default_factory=lambda: RiskThresholdBand(min=71, max=100))
...
class ToneSettings(BaseModel):
    tone: str = "profesional"          # suave|profesional|firme|urgente
    language: str = "es"
    company_name: str = ""
    signature: str = ""
